        ...
        success: function(respuesta){
            ...
            for (var i=0;i<respuesta.length;i++){
                 ...
                 $("#CuerpoImg").append(
                    ...
                    <button type="button" style="float: right; position:relative; display:none;" class="btn btn-danger evento">Danger</button>`
...
//eventos de imagenes pd. no se implementara
